...
if __name__ == "__main__":
    ...
    gb_videos_df['engagement_score'] = gb_videos_df['likes'] + gb_videos_df['dislikes'] + (gb_videos_df['comment_count'] * 5)
    gb_videos_df['engagement_per_view'] = gb_videos_df['engagement_score'] / gb_videos_df['views']
    gb_videos_df['category_name'] = gb_videos_df['category_id'].map(mapping_between_category_id_and_name)
    gb_videos_df['category_name'] = gb_videos_df['category_name'].fillna(gb_videos_df['category_id'].astype(str))

    plt.figure(figsize=(15, 8))
    sns.barplot(data=gb_videos_df, x='category_name', y='engagement_per_view', estimator='mean')
